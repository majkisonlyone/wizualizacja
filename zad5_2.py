...
def rotating_objects():
    ...
    global z_angle
    return [
        Sphere(0.5, 0.5, 0.5, (1, 0, 0, 1), [x_angle, y_angle, z_angle])
        .set_dimensions(0.3, 3)
        .display(),
        Sphere(-1, 1, 0.7, (1, 0, 0, 1), [x_angle, y_angle, z_angle])
        .set_dimensions(0.4, 3)
        .display(),
        Sphere(-0.2, -0.2, 0.2, (1, 0, 0, 1), [x_angle, y_angle, z_angle])
        .set_dimensions(0.5, 3)
        .display(),
    ]
